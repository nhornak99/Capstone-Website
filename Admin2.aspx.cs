...
public partial class Admin : System.Web.UI.Page
{
    ...
    private void FillDropDown()
    {
        ...
        using (SqlConnection con = new SqlConnection(@"Data Source=noah_pc\sqlexpress;Initial Catalog=SmartBusing;Integrated Security=True"/*@"Data Source=215-6565;Initial Catalog=SmartBusing;User ID=sa;Password=password24$"*/))/*(@"Data Source=noah_pc\sqlexpress;Initial Catalog=SmartBusing;Integrated Security=True"))*/
        {
    ...
    protected void districtList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack)
        {
            SqlConnection con = new SqlConnection(/*"Data Source=215-6565;Initial Catalog=SmartBusing;User ID=sa;Password=password24$"*/@"Data Source = noah_pc\sqlexpress; Initial Catalog = SmartBusing; Integrated Security = True");
            con.Open();
    ...
    private void BindGrid()
    {
        ...
        using (SqlConnection con = new SqlConnection(/*@"Data Source=215-6565;Initial Catalog=SmartBusing;User ID=sa;Password=password24$"*/@"Data Source=noah_pc\sqlexpress;Initial Catalog=SmartBusing;Integrated Security=True"))
        {
    ...
    //    SqlConnection con = new SqlConnection(cs);
    //    con.Open();
    //    SqlCommand cmd = new SqlCommand("UPDATE UserTbl SET FirstName='" + textName.Text + "',UserName='" + textUsername.Text + "',Password='" + textpassword.Text + "' WHERE District_ID='" + district + "", con);
    //}
    ...
    protected void AddNewUser(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=noah_pc\sqlexpress;Initial Catalog=SmartBusing;Integrated Security=True");
        SqlCommand cmd = new SqlCommand();
        cmd.CommandType = CommandType.Text;
