...
<head runat="server">
    <title>Smart Busing - Login</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <asp:Label ID="usernameLabel" runat="server" Text="Username" Font-Size="3em" CssClass="loginLbl"></asp:Label><br />
                                <asp:TextBox ID="usernameTB" runat="server" CssClass="logintextbox"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="passwordLabel" runat="server" Text="Password" Font-Size="3em" CssClass="loginLbl"></asp:Label><br />
                                <asp:TextBox ID="passwordTB" runat="server" CssClass="logintextbox"  TextMode="Password"></asp:TextBox>
                            </div>
                            <div class="form-group">
